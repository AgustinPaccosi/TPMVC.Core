...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TPMVC.Core.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TPMVC.Core.Entities.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TPMVC.Core.Entities.OrderDetail", b =>
                {
                    b.HasOne("TPMVC.Core.Entities.OrderHeader", "OrderHeader")
                        .WithMany("OrderDetail")
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TPMVC.Core.Entities.ShoeSize", "ShoeSizes")
                        .WithMany()
